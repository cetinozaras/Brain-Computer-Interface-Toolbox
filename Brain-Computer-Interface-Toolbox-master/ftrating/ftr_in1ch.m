...
%
% Example usage:
%  o=ftr_in1ch({'nkdeney-example.mat'},0.0,0.85,1:21,1);
...
freqthr=5;          %threshold frequency, Hz
...
ttidx=find(ismember(ftmrk,target));
